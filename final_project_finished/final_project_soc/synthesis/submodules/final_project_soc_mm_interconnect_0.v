...
// 
// Generated using ACDS version 14.0 200 at 2015.04.30.22:53:45
...
module final_project_soc_mm_interconnect_0 (
	...
	wire   [10:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire   [25:0] to_hw_port_s1_agent_m0_address;                                                     // to_hw_port_s1_agent:m0_address -> to_hw_port_s1_translator:uav_address
	...
	wire  [104:0] to_hw_port_s1_agent_rf_source_data;                                                 // to_hw_port_s1_agent:rf_source_data -> to_hw_port_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] to_hw_port_s1_agent_rsp_fifo_out_data;                                              // to_hw_port_s1_agent_rsp_fifo:out_data -> to_hw_port_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> to_hw_port_s1_agent:cp_data
	...
	wire   [25:0] to_hw_sig_s1_agent_m0_address;                                                      // to_hw_sig_s1_agent:m0_address -> to_hw_sig_s1_translator:uav_address
	...
	wire  [104:0] to_hw_sig_s1_agent_rf_source_data;                                                  // to_hw_sig_s1_agent:rf_source_data -> to_hw_sig_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] to_hw_sig_s1_agent_rsp_fifo_out_data;                                               // to_hw_sig_s1_agent_rsp_fifo:out_data -> to_hw_sig_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> to_hw_sig_s1_agent:cp_data
	...
	wire   [25:0] to_sw_port_s1_agent_m0_address;                                                     // to_sw_port_s1_agent:m0_address -> to_sw_port_s1_translator:uav_address
	...
	wire  [104:0] to_sw_port_s1_agent_rf_source_data;                                                 // to_sw_port_s1_agent:rf_source_data -> to_sw_port_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] to_sw_port_s1_agent_rsp_fifo_out_data;                                              // to_sw_port_s1_agent_rsp_fifo:out_data -> to_sw_port_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> to_sw_port_s1_agent:cp_data
	...
	wire   [25:0] to_sw_sig_s1_agent_m0_address;                                                      // to_sw_sig_s1_agent:m0_address -> to_sw_sig_s1_translator:uav_address
	...
	wire  [104:0] to_sw_sig_s1_agent_rf_source_data;                                                  // to_sw_sig_s1_agent:rf_source_data -> to_sw_sig_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] to_sw_sig_s1_agent_rsp_fifo_out_data;                                               // to_sw_sig_s1_agent_rsp_fifo:out_data -> to_sw_sig_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> to_sw_sig_s1_agent:cp_data
	...
	wire  [103:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire  [103:0] to_hw_port_s1_agent_rp_data;                                                        // to_hw_port_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] to_hw_sig_s1_agent_rp_data;                                                         // to_hw_sig_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [103:0] to_sw_port_s1_agent_rp_data;                                                        // to_sw_port_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [103:0] to_sw_sig_s1_agent_rp_data;                                                         // to_sw_sig_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [103:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_012:sink_data
	...
	final_project_soc_mm_interconnect_0_router_006 router_011 (
	...
	final_project_soc_mm_interconnect_0_router_006 router_012 (
	...
	final_project_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_cmd_mux_004 cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_project_soc_mm_interconnect_0_rsp_demux_004 rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
